...
本文件前半部分为中文概述；自下方「英文说明原文」标题起，为仓库既有英文说明全文，未逐段翻译。
...
另含：AI 工具使用说明（详见 `references.md`）、仓库目录结构、`flood_tool` 的安装步骤、`tool.py` 统一接口（分类、回归、坐标转换、清洗与辅助功能）、测试命令与延伸阅读等。**具体操作命令、参数与英文小节标题以后半部分英文原文为准。**

---

### 英文说明原文（未翻译）

以下从主标题起为项目原有英文文档，内容与排版保持原样。
